...
if(((vehicle player) != player) && (vehicle player) isKindOf "Ship") exitWith {hint "No puedes viajar rapido en barco"};

if !((vehicle player) call OT_fnc_vehicleCanMove)  exitWith {hint "Este vehiculo no se puede mover"};
