...
if(_money < _price) exitWith {"No puedes pagar esto!" call OT_fnc_notifyMinor};

private _veh = cursorTarget;
if(_veh getVariable ["OT_attachedClass",""] != "") exitWith {hint "Este vehiculo ya lleva un arma montada"};
