if !(captive player) exitWith {"No puedes reclutar si estas en busca y captura" call OT_fnc_notifyMinor};
...
"Escuadra reclutada. usa Ctrl + espacio para controlarla" call OT_fnc_notifyMinor;
