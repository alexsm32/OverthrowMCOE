...
if((vehicle player) getVariable ["stolen",false]) then {_owner = format["%1 (Robado)",_owner]};
[format[
	"<t align='left' size='1.2' color='#ffffff'>%1</t><br/><t size='0.5' color='#bbbbbb' align='left'>Propietario: %2</t>",
