...
private _effect = format["El pueblo dara impulso a la estabilidad %1 ayundando a calmar a la poblacion.<br/><t size='0.9'>Recompensa: $2,500 fondos para la resistencia, +10 (%1)</t>",_factionName];

//Build a mission description and title
private _description = format["%1 preferiria que %2 fuese controlado por la resistencia. Baja la estabilidad haciendo trabajos o matando gendarmes hasta 0%. <br/><br/>%3",_factionName,_destinationName,_effect];
            ...
            [
                {
                    ...
                    private _factionName = server getvariable format["factionname%1",_faction];
                    format ["Mensaje de %1: %2 captured. Donados $2500 a la resistencia ayudara a los esfuerzos de la poblacion civil. (+10 stabilidad, +10 %1)",_factionName,_destinationName] remoteExec ["OT_fnc_notifyMinor",0,false];
                },
